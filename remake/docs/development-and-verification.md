...
then continue through round4/5 to enemy132's typed attack-selection boundary in round6.
All generated64-slot orders, main RNG words, fifty receipts and4498 thinking bytes are checked
against the independent reduction, including the first131 occupied-cell fallback. Shared player-ready fixture
...
activation and round6 attack selection. Domain/Application cover wrong actor, stale/foreign/duplicate requests, receipt prefix,
...
test copy, actual round4 player1 ready, and actual round6 enemy132 attack-required. The intermediate
...
six pursuit receipts,4498 thinking bytes, final main07821234/copy0034 and no key/frame retry.
The changed authored activation expectation also invalidates `round-continuation` once; other modes
are selected only when their owning contracts change. Do not replay earlier modes solely for a new commit.

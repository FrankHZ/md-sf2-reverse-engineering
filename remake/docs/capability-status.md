...
| Private Map 3 player initial-reference-frame asset | fixed-root candidate builder plus reviewed local source/master/runtime/manifest transaction | **Admitted prerequisite** | half zero is only an initial reference frame and has no Godot consumer yet; live admission visibility, animation counter, movement-facing timing, DMA/cache completion, standing/idle meaning, hardware/display/final-pixel parity, and redistribution remain unclaimed |

...
public sealed class PrivateOriginalBattle01StartupTests
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void ChesterFirstKillCounterCannotBeOmittedOrRetrofittedUnderThePreviousPreset(bool newId)
    {
        var session = PendingSession(); var preset = OriginalBattle01ControlledPartyPreset.ChesterFirstKillComparison;

...
| [`inputs/map3-opening-party.json`](./inputs/map3-opening-party.json) | Controlled R1 party, resources and seeds for the connected world | Private exploration, entry and outcome tests; `SF2_PRIVATE_CONTROLLED_START` for the connected host |

...
$references = @(
    ...
    @{ Path = 'tests/fixtures/h3/counter-special-enemies-v1.json'; Id = 'sf2-counter-special-enemies-validation-v1' }
    @{ Path = 'tests/fixtures/h3/double-validation-v1.json'; Id = 'sf2-double-validation-gates-v1' }
)

...
from sf2tool.h2.stats import _combatant_getter_contract, build_stats_inventory
...
def test_combatant_getter_slice_preserves_stats_siblings_from_head() -> None:
    fixture = load_json(FIXTURE)
    ...
    assert set(output_schema["definitions"]) - set(head_output_schema.get("definitions", {})) == {
        ...
        "combatantGetterInstructionRecord",
    }

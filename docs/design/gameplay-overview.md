...
| input seam | **Confirmed** 的 raw sampling、current/repeat state 与 wait helpers | [input contract](./input-system.md)；`sf2-tech-services-static-v1`（[`tech-services-static-v1.json`](../../tests/fixtures/h2/tech-services-static-v1.json)） | controller protocol、frame-exact latency 与 player-visible repeat cadence |
...
| battle entry、turn 与 outcome | **Confirmed static** 的 new/resume、round/action/death/outcome ordering | [battle-loop research](../research/battle-loop.md)、[battle-functions research](../research/battle-functions.md)；`sf2-battle-functions-static-v1`（[`battle-functions-static-v1.json`](../../tests/fixtures/h2/battle-functions-static-v1.json)） | 完整 player-visible loop、runtime caller states 与战术解释 |

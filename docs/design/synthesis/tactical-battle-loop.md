...
| Choose attack, magic, item, or stay/search | The diamond menu records an action; cancellation restores the original position and leaves action `-1` | **Confirmed static**. Menu presentation, input cadence, and caller-visible timing are not fully closed at runtime. |
...
[physical combat](../contracts/combat-resolution.md) or [spell resolution](../contracts/spell-resolution.md).
...
| suspend handoff | **Confirmed static** menu/save/flag/transfer seam and bounded save format/actions | [battle-functions research](../../research/battle-functions.md) and `sf2-battle-functions-static-v1` ([`battle-functions-static-v1.json`](../../../tests/fixtures/h2/battle-functions-static-v1.json)) own the battlefield-menu → seconds/save/flag/transfer seam; the [save contract](../contracts/save-system.md) provides bounded format/action context | Cross-process battle persistence, power loss, visible UX |

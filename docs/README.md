...
- [`technical-graphics.md`](./research/technical-graphics.md)：解压、显示初始化、sprite/palette、视差、
  battle terrain/background/sprite/weapon/ground/portrait 完整 Stack corpus、flash script 及渲染
  parity 边界，以及 720 槽 map-sprite Basic-compression corpus。
...
- [`auxiliary-data-inventory.md`](./research/auxiliary-data-inventory.md)：graphics/scripting/technical/
  ...
  graphics/palette 与 670 个 map-sprite payload 的完整 parity。

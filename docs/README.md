...
- [`local-private-inputs.md`](./operations/local-private-inputs.md): the opt-in shared immutable-ROM
  resolver, worktree-local writable-state boundary, and serialized copy/verify/switch/delete route.
...
- [`field-search-control.md`](./research/field-search-control.md): the static `CheckArea` caller,
  faced-tile, block-dispatch, content, fallback, and rollback control spine with its grouped runtime
  Unknown register.
...
- [map3-messenger-acceptance.md](./research/map3-messenger-acceptance.md): the R2a continuation from
...
- [`map-event-flag-lifecycle-state.md`](./research/map-event-flag-lifecycle-state.md): the complete

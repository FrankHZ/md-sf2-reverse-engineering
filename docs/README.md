...
- [`common-scripting.md`](./research/common-scripting.md)：entity/map/text/credits 的 29 文件
  ...
  command 的 2,288 条 ordered program-site/handler/caller 合同、完整 entity-action 静态链和单启动 13-case/20-tick entity
  movement H3。
...
- [`map-exploration.md`](./design/map-exploration.md)：79-map import boundary、共享 block/layout
  ...
  trigger form、四个 source-named entity-placement form 与现代 renderer 的
  原版事实/未知/可现代化边界。

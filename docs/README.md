...
- [`runtime-rng-and-battle-math.md`](./research/runtime-rng-and-battle-math.md)：基础/调试覆盖 RNG、成长计算/完整升级与
...
- [`level-up.md`](./design/level-up.md)：成长曲线随机增益、最低成长补偿、完整升级顺序、
  `LEVELUP_ARGUMENTS` 结果合同，以及 TORT effective-level 缺陷的原版事实和重制选择边界。

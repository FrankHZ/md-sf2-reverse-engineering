...
- [`runtime-rng-and-battle-math.md`](./research/runtime-rng-and-battle-math.md)：基础/调试覆盖 RNG、成长计算/完整升级、投影/等级上限/法术继承边界与
  ...
  dodge、critical、spread、double/counter、死亡/距离/状态/阵营/特殊敌人后续校验及完整 double validator、HP/EXP 构造、持久回放、99 EXP 自然升级、BLAZE 2 四档 FIRE 抗性矩阵、DAO 四目标 power division、攻击法术 EXP、HEAL 1、SLEEP 1 四档 STATUS 抗性、DESOUL 即死/kill reward，以及 SPOIT MP 吸收回放的 H3 动态 fixture。
...
- [`spell-resolution.md`](./design/spell-resolution.md)：攻击法术的元素抗性位域、整数伤害调整、
  ...
  HEAL 1 治疗与治疗 EXP、SLEEP 1 状态抗性与免疫、DESOUL 即死/kill EXP/gold、SPOIT MP 吸收，以及临时状态/持久场景回放边界的实现无关合同。

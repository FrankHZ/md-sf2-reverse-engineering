...
`4409BBE29FCF0ABF5D46AA0B7C7C30096DFAA73429A3CD4E8425789ACC99E326`.
...
records across four files in this subtree.
...
Do not split these into six emulator startups. Static setup and outputs are compatible with a single
case table; split only if the item-definition or caller seam cannot be shared safely.

## Remaining Static Batches

- attack target construction and priority scripts;
- healing/support target eligibility and scoring;
- final battle-action selection and RNG weighting;

...
As of 2026-07-19, the index contains 1,437 confirmed findings and 1,838 checked address bindings. It
connects all 55 H3 fixture files plus the H2 symbol/table evidence needed by the completed code and

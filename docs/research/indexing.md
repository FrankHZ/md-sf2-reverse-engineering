...
As of 2026-07-19, the index contains 1,438 confirmed findings and 1,868 checked address bindings. It
connects all 58 H3 fixture files plus the H2 symbol/table evidence needed by the completed code and

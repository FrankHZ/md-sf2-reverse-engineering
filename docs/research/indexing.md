...
As of 2026-07-19, the index contains 1,440 confirmed findings and 1,874 checked address bindings. It
connects all 58 H3 fixture files plus 48 H2 fixtures needed by the completed code and

...
| Address bindings | 1,978 | Checked ROM/RAM relationships between fixtures and symbols/state |
...
verifier reports 381 unique code files, 980 unique data files, 65 H2 fixtures, 58 H3 fixtures, and
1,978 bindings. The

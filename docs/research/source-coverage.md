...
| H3 fixture files | 56 | Runtime contracts, often containing multiple cases |
| Address bindings | 1,843 | Checked ROM/RAM relationships between fixtures and symbols/state |
...
verifier reports 381 unique code files, 980 unique data files, 45 H2 fixtures, 56 H3 fixtures, and
1,843 bindings. The

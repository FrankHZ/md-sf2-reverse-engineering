...
| H2 fixture files | 90 | Deterministic source/ROM contracts, often covering complete corpora |
...
| Address bindings | 2,944 | Checked ROM/RAM relationships between fixtures and symbols/state |

...
Issue496 totals were **115 starts / 14197.020479699888 seconds / 365304 frames / 13351 batches**.
...
Earlier failures 16/21/41/56/61/64/67 remain preserved. At that Issue496 boundary, the next ordinary
nonneutral input effect remained **Unknown**. The [Issue515 native result](map3-messenger-acceptance.md#native-post-victory-ordinary-input-result-issue-515)
now records a fresh compatible natural chain with identical pre-input facts at 61009/61010, one Down
read and movement acceptance at 61011, then two settled frames at 61023/61024 on Map57 `(5,13)`.
The original destination increment, complete state readback, zero pending consumers and cleanup
are retained. Nineteen native segments complete normally; cumulative segmented costs are
136 starts / 15540.144989400113 seconds / 428408 frames / 16188 batches. Independent result acceptance
remains required before claiming RA-12 accepted. Remaining 8D, frozen replay, H4 and #437 completion
are not established by that ordinary-input observation.
...
| RA-07 | R4a static spine plus Issue #496 bounded natural victory, after-program return, flags and BattleLoop/SwitchMap/exploration observations | Prepared-67's post-return setup callback FAIL and false tail consumer remain preserved history. The [PR503-source prepared-86 result](map3-messenger-acceptance.md#native-victory-and-stable-field-readiness) confirms 67 matched operation pairs, after-program/shared-tail and enclosing return, flag/return spine, exact void setup and bounded two-frame stable field readiness. The [Issue515 result](map3-messenger-acceptance.md#native-post-victory-ordinary-input-result-issue-515) retains the same return spine and observes one post-endpoint Down input and settled displacement. Preserve reached effects/consumer boundaries at that scope; independent result acceptance, remaining 8D and H4 remain separate. |
...
| RA-12 | 5B defines endpoint shape only | First stable control after RA-07: map/egress, player position/facing, party and combatant status/stats/items/spells, gold, route/battle flags, RNG/time relevant to continuation; no pending battle/transfer/script/modal; next ordinary logical input is accepted and its state effect observed. The [Issue #496 terminal](map3-messenger-acceptance.md#native-victory-and-stable-field-readiness) confirms the named values and two neutral settled frames with actual input polls. The [Issue515 result](map3-messenger-acceptance.md#native-post-victory-ordinary-input-result-issue-515) now supplies the missing actual Down read/acceptance at 61011 and settled `(5,13)` state at 61023/61024, with complete original RAM readbacks and no pending consumers. This is evidence for independent acceptance of this row, not an automatic RA-12 completion claim. An ExplorationLoop call alone does not prove controllability. |

...
`combatantstats_1.asm` 的 31 个 getter、完整 instruction corpus、H1 地址、getter ABI 和
instruction-scoped caller inventory；setters/clamps 与 caller-dependent edge cases 仍在同一后续队列。

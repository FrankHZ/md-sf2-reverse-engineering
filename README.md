...
597 条物理 statement 和 80 次 script 调用。
...
target 与 84 个 initialization source 也已静态闭合。下一步继续解析 47 个 standalone setup script
和 binary block consumers，形成 Python-owned canonical 合同。只有 direct-`rts` stub reachability、

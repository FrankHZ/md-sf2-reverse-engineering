...
截至 2026-07-19，研究索引有 1,438 条 confirmed finding、46 个 H2 fixture、58 个 H3 fixture
和 1,868 个地址绑定。
...
payload parity；其余 Basic/嵌套 Stack corpus 和渲染帧继续归入静态批量 parity 与集中 presentation
矩阵，整个 terrain 解压批次没有模拟器启动。

...
截至 2026-07-19，研究索引有 434 条 confirmed finding、54 个 H3 fixture 和 830 个地址绑定。
按固定上游的 387 个 `disasm/code` ASM 文件作严格分母，已有可执行证据触达 357 个文件，即
**92.25% code-file reach**；这不是行/函数覆盖率，也不表示这些文件已全部理解。H2 的 14 个 ROM

...
截至 2026-07-19，研究索引有 1,439 条 confirmed finding、47 个 H2 fixture、58 个 H3 fixture
和 1,871 个地址绑定。
...
动画元数据、palette 边界及 106,496 个解压图形字节。其余 Basic/嵌套 Stack corpus 和渲染帧继续
归入静态批量 parity 与集中 presentation 矩阵，两个解压批次都没有模拟器启动。

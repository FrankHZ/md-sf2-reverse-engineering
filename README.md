...
截至 2026-07-19，研究索引有 528 条 confirmed finding、54 个 H3 fixture 和 924 个地址绑定。
...
items/spells/enemies 的 19 个布局文件也已完整盘点并复用既有深层 rail。严格 data-file reach
现为 78/1,690（4.62%）。H2 的 14 个 ROM

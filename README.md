...
截至 2026-07-18，研究索引有 145 条 confirmed finding、54 个 H3 fixture 和 537 个地址绑定。
...
集中 H3，以一次 BizHawk 启动确认 5 组传播、budget 128 桶回绕、平面跨行和边界预读结果，不拆成逐例启动。H3 以 7 组受控 seed 验证
